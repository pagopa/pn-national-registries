...
public class IniPecClient {
    ...
    private final AgidJwtSign agidJwtSign;
    private final ObjectMapper mapper;
    private final IniPecSecretConfig iniPecSecretConfig;


    protected IniPecClient(AccessTokenExpiringMap accessTokenExpiringMap,
                           ObjectMapper mapper,
                           AuthRest authRest,
                           AgidJwtSign agidJwtSign,
        ...
        String digest = createDigestFromPayload(s);
            return  webClient.get()
                    ...
                    .headers(httpHeaders -> {
                        ...
                        httpHeaders.add("Agid-JWT-Signature",agidJwtSign.createAgidJwt(digest) );
    ...
    public Mono<ResponsePecIniPec> callEServiceRequestPec(String correlationId){
        String s = convertToJson(correlationId);
        String digest = createDigestFromPayload(s);
        return  webClient.get()
                .uri(uriBuilder -> uriBuilder
