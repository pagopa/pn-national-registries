...
public class AnprClientConfig extends CommonBaseClient {
    ...
    E002ServiceApi e002ServiceApi() {
        ...
        apiClient.setBasePath(nationalRegistriesConfig.getAnpr().getBaseUrl());
    ...
    protected SslContext buildSslContext() {
        try {
            TrustData trustData = pnNationalRegistriesSecretService.getTrustedCertFromSecret(nationalRegistriesConfig.getAnpr().getTrustSecret());
