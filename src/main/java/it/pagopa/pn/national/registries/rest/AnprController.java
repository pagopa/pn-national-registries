...
public class AnprController implements GetAddressAnprApi {
     ...
     */
    @Override
    public Mono<ResponseEntity<GetAddressANPROKDto>> getAddressANPR(Mono<GetAddressANPRRequestBodyDto> getAddressANPRRequestBodyDto, final ServerWebExchange exchange){
