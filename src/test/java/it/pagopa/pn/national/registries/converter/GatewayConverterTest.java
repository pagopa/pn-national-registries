...
class GatewayConverterTest {
    ...
    void testIpaToSqsDto4() {
        ...
        AnprService anprService = new AnprService(new AnprConverter(mock(NationalRegistriesConfig.class)), mock(AnprClient.class), counterRepository, validateTaxIdUtils);
